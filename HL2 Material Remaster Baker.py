...
def create_or_update_old_map_plane(props, create_if_missing=True):
    ...
    if original_plane:
        ...
        old_location = (base_location.x - plane_size - 1.0, base_location.y, base_location.z)
    else:
        old_location = (-plane_size - 1.0, 0.0, 0.0)
...
def create_or_update_test_maps_plane(props):
    ...
    if original_plane:
        base_location = original_plane.location.copy()
        test_location = (
            base_location.x + plane_size + 1.0,
            base_location.y,
            base_location.z,
        )
    else:
        test_location = (plane_size + 1.0, 0.0, 0.0)
...
def draw_hl2_panel(layout, context, compact=False):
    ...
    if props.use_source_as_camera_background:
        setup_box.prop(props, "camera_bg_opacity")
